...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    // Grab data
    $start_time = date( "Y-m-d H:i:s", $temptimestamp );
    $end_time   = date(  "Y-m-d H:i:s", $temptimestamp+24*60*60 );
    $res = mysql_query("select * from log where date_and_time >= '".$start_time."' AND date_and_time <= '".$end_time."';");
